    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/img1.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> bag number 1</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bag1.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>bag number 2</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bag3.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>bag number 3</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bag4.jpg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> bag number 4</h3>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy lkeys shop All Rights Reserved.</p>
                   <p>This website is developed by lydie kavira ketya</p>
               </center>
               </div>
           </footer>
        </div>
